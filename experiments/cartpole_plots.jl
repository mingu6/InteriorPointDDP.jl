...
push!(bplots, boxplot(objs_ipob, title=names[3], titlefontsize=10, legend=false, ylims=(ymin, 15), xticks=[]))
...
bplots = []
push!(bplots, boxplot(iters_ipd, title=names[1], titlefontsize=10, legend=false, xticks=[], ylims=(0, 250)))
push!(bplots, boxplot(iters_ipo, title=names[2], titlefontsize=10, legend=false, xticks=[], ylims=(0, 250)))
push!(bplots, boxplot(iters_ipob, title=names[3], titlefontsize=10, legend=false, xticks=[], ylims=(0, 2000)))
push!(bplots, boxplot(iters_al, title=names[4], titlefontsize=10, legend=false, xticks=[], ylims=(0, 2000)))
plot(bplots..., size=(400, 300), layout=(1, 4))
...
bplots = []
push!(bplots, boxplot(wall_ipd, title=names[1], titlefontsize=10, legend=false, xticks=[], ylims=(0, 400)))
push!(bplots, boxplot(wall_ipo, title=names[2], titlefontsize=10, legend=false, xticks=[], ylims=(0, 400)))
push!(bplots, boxplot(wall_ipob, title=names[3], titlefontsize=10, legend=false, xticks=[], ylims=(0, 6050)))
