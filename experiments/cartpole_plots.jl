...
boxplot(names, [objs_ipd objs_ipo objs_ipob objs_al], legend=false, fontfamily=font_,
    xtickfontsize=fs_x, ytickfontsize=fs_y, ylims=(0.0, 5.1), size=(650, 500))
savefig("plots/$problemclass/objective3.pdf")
...
boxplot(names, [constrs_ipd constrs_ipo constrs_ipob constrs_al], legend=false, yticks=[1e-16, 1e-12, 1e-8, 1e-4, 1],
    fontfamily=font_, xtickfontsize=fs_x, ytickfontsize=fs_y-3, yaxis=:log10, ylims=(1e-16, 1e1), size=(650, 500))
savefig("plots/$problemclass/constr3.pdf")

# iteration count

boxplot(names, [iters_ipd iters_ipo iters_ipob iters_al], legend=false,
    fontfamily=font_, xtickfontsize=fs_x, ytickfontsize=fs_y-3, ylims=(0, 1130), size=(650, 500))
savefig("plots/$problemclass/iterations3.pdf")

# wall time per iteration

boxplot(names[:, 1:3], [(wall_ipd ./ iters_ipd) (wall_ipo ./ iters_ipo) (wall_ipob ./ iters_ipob)], legend=false,
    fontfamily=font_, xtickfontsize=fs_x-3, ytickfontsize=fs_y, ylims=(0, 5.9), size=(500, 500))
savefig("plots/$problemclass/time3.pdf")
