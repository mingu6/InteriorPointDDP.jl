...
boxplot(names, [objs_ipd objs_ipo objs_ipob objs_al], legend=false, yaxis=:log10, ylims=(1e-1, 3e4),
    fontfamily=font_, xtickfontsize=fs_x, ytickfontsize=fs_y, size=(650, 500))
savefig("plots/$problemclass/objective0.pdf")
...
savefig("plots/$problemclass/constr0.pdf")
...
savefig("plots/$problemclass/iterations0.pdf")

# wall time per iteration

boxplot(names[:, 1:3], [(wall_ipd ./ iters_ipd) (wall_ipo ./ iters_ipo) (wall_ipob ./ iters_ipob)], legend=false,
    fontfamily=font_, xtickfontsize=fs_x-3, ytickfontsize=fs_y, ylims=(0, 4.9), size=(500, 500))
savefig("plots/$problemclass/time0.pdf")
