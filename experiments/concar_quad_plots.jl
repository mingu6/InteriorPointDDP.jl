...
bplots = []
push!(bplots, boxplot(constrs_ipd, title=names[1], titlefontsize=10, legend=false, xticks=[], yaxis=:log10, ylims=(1e-16, 1e-4)))
push!(bplots, boxplot(constrs_ipo, title=names[2], titlefontsize=10, legend=false, xticks=[], yaxis=:log10, ylims=(1e-16, 1e-4)))
push!(bplots, boxplot(constrs_ipob, title=names[3], titlefontsize=10, legend=false, xticks=[], yaxis=:log10, ylims=(1e-16, 1e-4)))
push!(bplots, boxplot(constrs_al, title=names[4], titlefontsize=10, legend=false, xticks=[], yaxis=:log10, ylims=(1e-16, 1e-4)))
...
push!(bplots, boxplot(iters_ipob, title=names[3], titlefontsize=10, legend=false, xticks=[], ylims=(0, 1200)))
push!(bplots, boxplot(iters_al, title=names[4], titlefontsize=10, legend=false, xticks=[], ylims=(0, 1200)))
plot(bplots..., size=(400, 300), layout=(1, 4))
...
push!(bplots, boxplot(wall_ipob, title=names[3], titlefontsize=10, legend=false, xticks=[], ylims=(0, 3500)))
