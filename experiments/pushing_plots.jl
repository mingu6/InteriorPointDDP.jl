...
boxplot(names, [constrs_ipd constrs_ipo constrs_ipob constrs_al], legend=false, yticks=[1e-16, 1e-12, 1e-8, 1e-4, 1],
    xtickfontsize=fs_x, ytickfontsize=fs_y-3, yaxis=:log10, ylims=(1e-18, 2e1), size=(650, 500))
savefig("plots/$problemclass/constr4.svg")

# iteration count

boxplot(names, [iters_ipd iters_ipo iters_ipob iters_al], legend=false,
    xtickfontsize=fs_x, ytickfontsize=fs_y-3, ylims=(0, 2050), size=(650, 500))
savefig("plots/$problemclass/iterations4.svg")
