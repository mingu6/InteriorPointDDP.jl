Base.@kwdef mutable struct Options{T}
    ...
    κ_1::Float64 = 0.1        # dual variable initialisation value TODO: change name
    κ_2::Float64 = 0.01       # slack variable initialisation value
    ...
    s_max::Float64 = 100      # scaling threshold for NLP error
